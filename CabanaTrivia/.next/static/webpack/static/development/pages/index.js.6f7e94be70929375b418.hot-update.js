...
var CategoriesComponent = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(CategoriesComponent, [{
    ...
    value: function onClickGeneralKnowledge() {
      //const hasChosenCount = this.state.count + 1
      this.setState({
        generalKnowledge: !this.state.generalKnowledge
      }); // if(!this.state.generalKnowledge) { this.setState({ count: this.state.count + 1 }) }
      // else { this.setState({ count: this.state.count - 1 }) } ;
      //  this.setState({ count: this.state.count + 1 })
      //console.log(this.generalKnowledge);

      !this.state.generalKnowledge ? this.incrementCount() : this.decrementCount(); // if(!this.state.generalKnowledge) { this.incrementCount() }
      // else { this.decrementCount() } ;
    }
  }, {
    key: "onClickFilm",
    ...
    value: function render() {
      ...
      console.log(this.state.generalKnowledge);
...
//# sourceMappingURL=index.js.6f7e94be70929375b418.hot-update.js.map