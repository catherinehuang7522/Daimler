  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(QuestionsComponent, [{
    ...
    value: function getUrls() {
      ...
      for (var index = 0; index < this.props.cat.length; index++) {
        var customID = "https://opentdb.com/api.php?amount=" + numQs + "&category=" + _constants__WEBPACK_IMPORTED_MODULE_17__["CATEGORIES_MAP"][index] + "&difficulty=" + this.props.diff; //Add category to array
    ...
    value: function render() {
      ...
      console.log("URLS " + this.state.urlLinks);
      return __jsx("div", {
...
//# sourceMappingURL=index.js.23e24d6bd7385166ca58.hot-update.js.map