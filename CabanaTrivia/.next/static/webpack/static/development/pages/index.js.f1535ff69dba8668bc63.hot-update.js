      ...
      return _babel_runtime_corejs2_regenerator__WEBPACK_IMPORTED_MODULE_1___default.a.async(function onGetQuestions$(_context) {
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 19:
              console.log("this are the questions before:  " + allData);
              this.shuffleArray(allData);
              allData.slice(0, MAX_NUM_QUESTIONS);
              console.log(" ");
              console.log("these are the questions after:  " + allData); //shuffle array, trim the array up to the MAX number of questions
...
//# sourceMappingURL=index.js.f1535ff69dba8668bc63.hot-update.js.map