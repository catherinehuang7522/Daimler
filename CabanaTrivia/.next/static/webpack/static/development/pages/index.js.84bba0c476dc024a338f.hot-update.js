  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(QuestionsComponent, [{
    ...
    value: function getUrls(finalArray) {
      ...
      for (var i = 0; i < finalArray.length; i++) {
        customURL = "https://opentdb.com/api.php?amount=" + numQs + "&category=" + _constants__WEBPACK_IMPORTED_MODULE_17__["CATEGORIES_MAP"][finalArray[i]] + "&difficulty=" + this.props.diff; //Add URL LINK to array
    ...
    value: function onGetQuestions(category) {
      var arrayWeGet, allUrls, finalCateg, difficulty, numQs, response, allData;
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            case 0:
              ...
              allUrls = this.getUrls(arrayWeGet);
...
//# sourceMappingURL=index.js.84bba0c476dc024a338f.hot-update.js.map