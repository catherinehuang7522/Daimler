...
var QuestionsComponent = /*#__PURE__*/function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(QuestionsComponent, [{
    ...
    value: function getUrls() {
      ...
      var customURL1 = "https://opentdb.com/api.php?amount=" + numQs + "&category=" + _constants__WEBPACK_IMPORTED_MODULE_17__["CATEGORIES_MAP"][this.props.cat[0]] + "&difficulty=" + this.props.diff;
      var customURL2 = "https://opentdb.com/api.php?amount=" + numQs + "&category=" + _constants__WEBPACK_IMPORTED_MODULE_17__["CATEGORIES_MAP"][this.props.cat[1]] + "&difficulty=" + this.props.diff; //Add URL LINK to array

      var link = this.state.urlLinks.concat(customURL1);
      this.setState({
        urlLinks: link
      });
      var link2 = this.state.urlLinks.concat(customURL2);
      this.setState({
        urlLinks: link2
      }); //  }
...
//# sourceMappingURL=index.js.c6e9079190b93e6ef920.hot-update.js.map