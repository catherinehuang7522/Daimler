  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_3__["default"])(QuestionsComponent, [{
    ...
    value: function getUrls() {
      ...
      for (var i = 0; i < this.props.cat.length; i++) {
        var customURL = "https://opentdb.com/api.php?amount=" + numQs + "&category=" + _constants__WEBPACK_IMPORTED_MODULE_17__["CATEGORIES_MAP"][this.props.cat[i]] + "&difficulty=" + this.props.diff;
        urlLinks.push(customURL); //Add URL LINK to array
        //  var link = this.state.urlLinks.concat(customURL)
        //  this.setState({urlLinks : link })
      }

      console.log("URLS " + urlLinks);
...
//# sourceMappingURL=index.js.edccaad3509087625187.hot-update.js.map